...
- (void) setUpRegistView
{
    ...
    NSString *allString = @"我已经阅读并同意《皇冠足球经典推荐用户协议》";
    NSMutableAttributedString *string = [[NSMutableAttributedString alloc] initWithString:allString];
    [string addAttribute:NSForegroundColorAttributeName value:MainColor range:[allString rangeOfString:@"《皇冠足球经典推荐用户协议》"]];
    ...
    [[AFNetWW sharedAFNetWorking] AFWithPostORGet:@"get" withURLStr:url WithParameters:nil success:^(id responseDic) {
        ...
        if (rescode == 10000) {
            ...
            [self.bridge callHandler:@"testJavascriptHandler" data:dat responseCallback:^(id responseData) {
                ...
                NSDictionary *dic=@{@"username":self.phoneNumber.text, @"password" : password,@"mobileinfo" : @{@"imei" : imei, @"ver" : [[UIDevice currentDevice] systemVersion], @"ostype" : @"2",@"jpush_regid" : @""}};
