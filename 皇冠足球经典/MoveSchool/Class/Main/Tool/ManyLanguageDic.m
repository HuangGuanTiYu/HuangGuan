...
-(NSDictionary *)introduceDic{
    ...
    _introduceDic=@{
                    @"0":@"皇冠足球经典推荐（www.ydxt.com）是北京智同体科技有限公司的产品，我们以培养企业岗位技能人才为己任，立志让每一家企业都有皇冠足球经典推荐，为企业用户提供贴心周到的服务。皇冠足球经典推荐，专注于企业移动学习三大板块业务：移动学习平台建设、精品微课开发、社群学习运营服务。现有成熟产品：皇冠足球经典推荐（PC端+APP+H5）、2000余门Flash精品微课、近100个项目化社群学习运营服务专案，为1000余家企业、培训机构提供移动学习服务。",
...
-(NSDictionary *)SettingDic{
    ...
    _SettingDic=@{
                  ...
                  @"皇冠足球经典推荐" :  @{@"0":@"皇冠足球经典推荐",@"1":@"About us",@"2":@"우리에 관하여",@"3":@"私たちについて",@"4":@"Informatie"},
                  @"语言选择" :  @{@"0":@"语言选择",@"1":@"Language setup",@"2":@"언어 설정",@"3":@"言語のセッティング",@"4":@"Taal instelling"},
                  @"皇冠足球经典推荐" :  @{@"0":@"皇冠足球经典推荐",@"1":@"Iglobalview",@"2":@"거노버",@"3":@"「iglobalview」",@"4":@"Iglobalview"},
...
-(NSDictionary *)loginDic{
    ...
    _loginDic=@{
                ...
                @"欢迎登录皇冠足球经典推荐" :  @{@"0" : @"   欢迎登录皇冠足球经典推荐", @"1" : @"You are welcome to log in YDXT", @"2" : @"거노버에 로그인하신 것을 YDXT",@"3" : @"「YDXT」へようこそ。",@"4" : @"U bent van harte welkom om in YDXT te loggen"},
